...
if __name__ == "__main__":
    input_folder_path = "/storage/emulated/0/Pictures/sr/"
    output_folder_path = "/storage/emulated/0/Download/QQ/"
    watermark_text = "634944989"
    font_file_path = "/data/data/com.termux/files/home/DINCOND-BOLD.otf"
    text_size = 50
    spacing = 50
    alpha = 20
    angle = 45
